...
L'affichage est automatique : aucune touche nécessaire. Les icônes mesurent 16 pixels d'interface, avec 4 pixels entre leurs cellules. Elles apparaissent après réception d'une observation pertinente, ou cinq minutes avant un raid prévu. Elles restent visibles pendant le chat : cliquer sur une arène ouverte envoie la même demande de téléportation visiteur que le bouton officiel Tropimon. Cliquer sur un raid ou son rappel envoie `/warp raid`, comme le bouton des Ruines antiques du navigateur officiel. Aucun déplacement n'est automatique. Les autres clics restent disponibles pour le chat. Le HUD est masqué dans les autres menus, dont le navigateur d'arènes.
...
- Miracles : étoiles shiny Cobblemon, bonbon XP XL, bonbon IV et Super Baie Enigma pour le talent caché. Les durées restent lisibles sous les icônes (heures, minutes, secondes), sur deux lignes si nécessaire, sans réduire la police. Les changements de région conservent les états connus. Une reconnexion conserve en mémoire les miracles non expirés du même joueur et les restaure après reconnaissance de Tropimon ; une nouvelle annonce ou une liste vide fait autorité. Aucun fichier de session n'est écrit.
...
La détection d'un raid déjà démarré avant la connexion n'est pas garantie : les modèles officiels de navigateur et de présentation des raids inspectés n'exposent pas son état actif. Sans annonce ou barre de boss identifiable reçue, aucun raid en cours n'est fabriqué à partir de l'horaire. La récupération globale de cet état nécessite une source serveur supplémentaire.

## Barons et Xaero

Les Pokémon sauvages dont le statut Alpha est transmis par Cobblemon sont signalés visuellement, sans aucun son. Aucune liste de Barons, aucun portrait ni texte de distance ou de niveau ne sont affichés en haut à gauche. Les Pokémon possédés et les clones de combat sont exclus. Un Pokémon déchargé disparaît du radar.

Avec Xaero, un contour rouge entoure l'icône déjà sélectionnée par la minimap et la carte du monde, sans remplacer son image ni ses couleurs. Le symbole Alpha officiel de Cobblemon conserve l'emplacement et la taille des étoiles shiny du pack E19 intégré à Tropimon. Un Baron shiny conserve ses étoiles à droite et reçoit le symbole Alpha à gauche. Le symbole est lu dans Cobblemon, sans copie de ses ressources dans le JAR. Si Xaero affiche des points, celui du Baron devient rouge. Les réglages de visibilité et les restrictions du radar restent respectés ; Events n'active pas des icônes désactivées dans Xaero. Sans Xaero, les événements et les arènes restent disponibles dans le HUD. Seuls les Pokémon déjà transmis au client sont détectables.
